...
class CPUContext {
    ...
    cb: { [key : number] : Function } = {
        //RLC
        0x00: () => { this._state.b = this.cb_rlc(this._state.b); },
        0x01: () => { this._state.c = this.cb_rlc(this._state.c); },
        0x02: () => { this._state.d = this.cb_rlc(this._state.d); },
        0x03: () => { this._state.e = this.cb_rlc(this._state.e); },
        0x04: () => { this._state.h = this.cb_rlc(this._state.h); },
        0x05: () => { this._state.l = this.cb_rlc(this._state.l); },
        0x06: () => { const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_rlc(this._mmu.read_byte(addr)));},
        0x07: () => { this._state.a = this.cb_rlc(this._state.a); },

        //RRC
        0x08: () => { this._state.b = this.cb_rrc(this._state.b); },
        0x09: () => { this._state.c = this.cb_rrc(this._state.c); },
        0x0A: () => { this._state.d = this.cb_rrc(this._state.d); },
        0x0B: () => { this._state.e = this.cb_rrc(this._state.e); },
        0x0C: () => { this._state.h = this.cb_rrc(this._state.h); },
        0x0D: () => { this._state.l = this.cb_rrc(this._state.l); },
        0x0E: () => { const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_rrc(this._mmu.read_byte(addr)));},
        0x0F: () => { this._state.a = this.cb_rrc(this._state.a); },

        //RL
        0x10: () => { this._state.b = this.cb_rl(this._state.b); },
        0x11: () => { this._state.c = this.cb_rl(this._state.c); },
        0x12: () => { this._state.d = this.cb_rl(this._state.d); },
        0x13: () => { this._state.e = this.cb_rl(this._state.e); },
        0x14: () => { this._state.h = this.cb_rl(this._state.h); },
        0x15: () => { this._state.l = this.cb_rl(this._state.l); },
        0x16: () => { const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_rl(this._mmu.read_byte(addr)));},
        0x17: () => { this._state.a = this.cb_rl(this._state.a); },

        //RR
        0x18: () => { this._state.b = this.cb_rr(this._state.b); },
        0x19: () => { this._state.c = this.cb_rr(this._state.c); },
        0x1A: () => { this._state.d = this.cb_rr(this._state.d); },
        0x1B: () => { this._state.e = this.cb_rr(this._state.e); },
        0x1C: () => { this._state.h = this.cb_rr(this._state.h); },
        0x1D: () => { this._state.l = this.cb_rr(this._state.l); },
        0x1E: () => { const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_rr(this._mmu.read_byte(addr)));},
        0x1F: () => { this._state.a = this.cb_rr(this._state.a); },

        //SLA
        0x20: () => { this._state.b = this.cb_sla(this._state.b); },
        0x21: () => { this._state.c = this.cb_sla(this._state.c); },
        0x22: () => { this._state.d = this.cb_sla(this._state.d); },
        0x23: () => { this._state.e = this.cb_sla(this._state.e); },
        0x24: () => { this._state.h = this.cb_sla(this._state.h); },
        0x25: () => { this._state.l = this.cb_sla(this._state.l); },
        0x26: () => { const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_sla(this._mmu.read_byte(addr)));},
        0x27: () => { this._state.a = this.cb_sla(this._state.a); },

        //SRA
        0x28: () => { this._state.b = this.cb_sra(this._state.b); },
        0x29: () => { this._state.c = this.cb_sra(this._state.c); },
        0x2A: () => { this._state.d = this.cb_sra(this._state.d); },
        0x2B: () => { this._state.e = this.cb_sra(this._state.e); },
        0x2C: () => { this._state.h = this.cb_sra(this._state.h); },
        0x2D: () => { this._state.l = this.cb_sra(this._state.l); },
        0x2E: () => { const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_sra(this._mmu.read_byte(addr)));},
        0x2F: () => { this._state.a = this.cb_sra(this._state.a); },

        //SWAP
        0x30: () => { this._state.b = this.cb_swap(this._state.b); },
        0x31: () => { this._state.c = this.cb_swap(this._state.c); },
        0x32: () => { this._state.d = this.cb_swap(this._state.d); },
        0x33: () => { this._state.e = this.cb_swap(this._state.e); },
        0x34: () => { this._state.h = this.cb_swap(this._state.h); },
        0x35: () => { this._state.l = this.cb_swap(this._state.l); },
        0x36: () => { const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_swap(this._mmu.read_byte(addr)));},
        0x37: () => { this._state.a = this.cb_swap(this._state.a); },

        //SRL
        0x38: () => { this._state.b = this.cb_srl(this._state.b); },
        0x39: () => { this._state.c = this.cb_srl(this._state.c); },
        0x3A: () => { this._state.d = this.cb_srl(this._state.d); },
        0x3B: () => { this._state.e = this.cb_srl(this._state.e); },
        ...
        0x41: () => { this.bit(0, this._state.c); },
        0x42: () => { this.bit(0, this._state.d); },
        0x43: () => { this.bit(0, this._state.e); },
        0x44: () => { this.bit(0, this._state.h); },
        0x45: () => { this.bit(0, this._state.l); },
        0x46: () => { this.bit(0, this._mmu.read_byte(get_hl(this._state))); },
        0x47: () => { this.bit(0, this._state.a); },

        //BIT 1
        0x48: () => { this.bit(1, this._state.b); },
        0x49: () => { this.bit(1, this._state.c); },
        0x4A: () => { this.bit(1, this._state.d); }, 
        0x4B: () => { this.bit(1, this._state.e); },
        0x4C: () => { this.bit(1, this._state.h); }, 
        0x4D: () => { this.bit(1, this._state.l); },
        0x4E: () => { this.bit(1, this._mmu.read_byte(get_hl(this._state))); },
        0x4F: () => { this.bit(1, this._state.a); },

        //BIT 2
        0x50: () => { this.bit(2, this._state.b); },
        0x51: () => { this.bit(2, this._state.c); },
        0x52: () => { this.bit(2, this._state.d); },
        0x53: () => { this.bit(2, this._state.e); },
        0x54: () => { this.bit(2, this._state.h); },
        0x55: () => { this.bit(2, this._state.l); },
        0x56: () => { this.bit(2, this._mmu.read_byte(get_hl(this._state))); },
        0x57: () => { this.bit(2, this._state.a); },

        //BIT 3
        0x58: () => { this.bit(3, this._state.b); },
        0x59: () => { this.bit(3, this._state.c); },
        0x5A: () => { this.bit(3, this._state.d); },
        0x5B: () => { this.bit(3, this._state.e); },
        0x5C: () => { this.bit(3, this._state.h); },
        0x5D: () => { this.bit(3, this._state.l); },
        0x5E: () => { this.bit(3, this._mmu.read_byte(get_hl(this._state))); },
        0x5F: () => { this.bit(3, this._state.a); },

        //BIT 4
        0x60: () => { this.bit(4, this._state.b); },
        0x61: () => { this.bit(4, this._state.c); }, 
        0x62: () => { this.bit(4, this._state.d); },
        0x63: () => { this.bit(4, this._state.e); },
        0x64: () => { this.bit(4, this._state.h); },
        0x65: () => { this.bit(4, this._state.l); },
        0x66: () => { this.bit(4, this._mmu.read_byte(get_hl(this._state))); },
        0x67: () => { this.bit(4, this._state.a); },

        //BIT 5
        0x68: () => { this.bit(5, this._state.b); },
        0x69: () => { this.bit(5, this._state.c); },
        0x6A: () => { this.bit(5, this._state.d); },
        0x6B: () => { this.bit(5, this._state.e); },
        0x6C: () => { this.bit(5, this._state.h); },
        0x6D: () => { this.bit(5, this._state.l); },
        0x6E: () => { this.bit(5, this._mmu.read_byte(get_hl(this._state))); },
        0x6F: () => { this.bit(5, this._state.a); },

        //BIT 6
        0x70: () => { this.bit(6, this._state.b); },
        0x71: () => { this.bit(6, this._state.c); },
        0x72: () => { this.bit(6, this._state.d); },
        0x73: () => { this.bit(6, this._state.e); },
        0x74: () => { this.bit(6, this._state.h); },
        0x75: () => { this.bit(6, this._state.l); },
        0x76: () => { this.bit(6, this._mmu.read_byte(get_hl(this._state))); },
        0x77: () => { this.bit(6, this._state.a); },

        //BIT 7
        0x78: () => { this.bit(7, this._state.b); },
        0x79: () => { this.bit(7, this._state.c); },
        0x7A: () => { this.bit(7, this._state.d); },
        0x7B: () => { this.bit(7, this._state.e); },
        0x7C: () => { this.bit(7, this._state.h); },
        0x7D: () => { this.bit(7, this._state.l); },
        0x7E: () => { this.bit(7, this._mmu.read_byte(get_hl(this._state))); },
        0x7F: () => { this.bit(7, this._state.a); },

        //RES 0
        0x80: () => {this._state.b = this.cb_res(0, this._state.b);},
        0x81: () => {this._state.c = this.cb_res(0, this._state.c);},
        0x82: () => {this._state.d = this.cb_res(0, this._state.d);},
        0x83: () => {this._state.e = this.cb_res(0, this._state.e);},
        0x84: () => {this._state.h = this.cb_res(0, this._state.h);},
        0x85: () => {this._state.l = this.cb_res(0, this._state.l);},
        0x86: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_res(0, this._mmu.read_byte(addr)));},
        0x87: () => {this._state.a = this.cb_res(0, this._state.a);},

        //RES 1
        0x88: () => {this._state.b = this.cb_res(1, this._state.b);},
        0x89: () => {this._state.c = this.cb_res(1, this._state.c);},
        0x8A: () => {this._state.d = this.cb_res(1, this._state.d);},
        0x8B: () => {this._state.e = this.cb_res(1, this._state.e);},
        0x8C: () => {this._state.h = this.cb_res(1, this._state.h);},
        0x8D: () => {this._state.l = this.cb_res(1, this._state.l);},
        0x8E: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_res(1, this._mmu.read_byte(addr)));},
        0x8F: () => {this._state.a = this.cb_res(1, this._state.a);},

        //RES 2
        0x90: () => {this._state.b = this.cb_res(2, this._state.b);},
        0x91: () => {this._state.c = this.cb_res(2, this._state.c);},
        0x92: () => {this._state.d = this.cb_res(2, this._state.d);},
        0x93: () => {this._state.e = this.cb_res(2, this._state.e);},
        0x94: () => {this._state.h = this.cb_res(2, this._state.h);},
        0x95: () => {this._state.l = this.cb_res(2, this._state.l);},
        0x96: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_res(2, this._mmu.read_byte(addr)));},
        0x97: () => {this._state.a = this.cb_res(2, this._state.a);},

        //RES 3
        0x98: () => {this._state.b = this.cb_res(3, this._state.b);},
        0x99: () => {this._state.c = this.cb_res(3, this._state.c);},
        0x9A: () => {this._state.d = this.cb_res(3, this._state.d);},
        0x9B: () => {this._state.e = this.cb_res(3, this._state.e);},
        ...
        0xA1: () => {this._state.c = this.cb_res(4, this._state.c);},
        0xA2: () => {this._state.d = this.cb_res(4, this._state.d);},
        0xA3: () => {this._state.e = this.cb_res(4, this._state.e);},
        0xA4: () => {this._state.h = this.cb_res(4, this._state.h);},
        0xA5: () => {this._state.l = this.cb_res(4, this._state.l);},
        0xA6: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_res(4, this._mmu.read_byte(addr)));},
        0xA7: () => {this._state.a = this.cb_res(4, this._state.a);},

        //RES 5
        0xA8: () => {this._state.b = this.cb_res(5, this._state.b);},
        0xA9: () => {this._state.c = this.cb_res(5, this._state.c);},
        0xAA: () => {this._state.d = this.cb_res(5, this._state.d);},
        0xAB: () => {this._state.e = this.cb_res(5, this._state.e);},
        0xAC: () => {this._state.h = this.cb_res(5, this._state.h);},
        0xAD: () => {this._state.l = this.cb_res(5, this._state.l);},
        0xAE: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_res(5, this._mmu.read_byte(addr)));},
        0xAF: () => {this._state.a = this.cb_res(5, this._state.a);},

        //RES 6
        0xB0: () => {this._state.b = this.cb_res(6, this._state.b);},
        0xB1: () => {this._state.c = this.cb_res(6, this._state.c);},
        0xB2: () => {this._state.d = this.cb_res(6, this._state.d);},
        0xB3: () => {this._state.e = this.cb_res(6, this._state.e);},
        0xB4: () => {this._state.h = this.cb_res(6, this._state.h);},
        0xB5: () => {this._state.l = this.cb_res(6, this._state.l);},
        0xB6: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_res(6, this._mmu.read_byte(addr)));},
        0xB7: () => {this._state.a = this.cb_res(6, this._state.a);},

        //RES 7
        0xB8: () => {this._state.b = this.cb_res(7, this._state.b);},
        0xB9: () => {this._state.c = this.cb_res(7, this._state.c);},
        0xBA: () => {this._state.d = this.cb_res(7, this._state.d);},
        0xBB: () => {this._state.e = this.cb_res(7, this._state.e);},
        0xBC: () => {this._state.h = this.cb_res(7, this._state.h);},
        0xBD: () => {this._state.l = this.cb_res(7, this._state.l);},
        0xBE: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_res(7, this._mmu.read_byte(addr)));},
        0xBF: () => {this._state.a = this.cb_res(7, this._state.a);},

        //SET 0
        0xC0: () => {this._state.b = this.cb_set(0, this._state.b);},
        0xC1: () => {this._state.c = this.cb_set(0, this._state.c);},
        0xC2: () => {this._state.d = this.cb_set(0, this._state.d);},
        0xC3: () => {this._state.e = this.cb_set(0, this._state.e);},
        0xC4: () => {this._state.h = this.cb_set(0, this._state.h);},
        0xC5: () => {this._state.l = this.cb_set(0, this._state.l);},
        0xC6: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_set(0, this._mmu.read_byte(addr)));},
        0xC7: () => {this._state.a = this.cb_set(0, this._state.a);},

        //SET 1
        0xC8: () => {this._state.b = this.cb_set(1, this._state.b);},
        0xC9: () => {this._state.c = this.cb_set(1, this._state.c);},
        0xCA: () => {this._state.d = this.cb_set(1, this._state.d);},
        0xCB: () => {this._state.e = this.cb_set(1, this._state.e);},
        0xCC: () => {this._state.h = this.cb_set(1, this._state.h);},
        0xCD: () => {this._state.l = this.cb_set(1, this._state.l);},
        0xCE: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_set(1, this._mmu.read_byte(addr)));},
        0xCF: () => {this._state.a = this.cb_set(1, this._state.a);},

        //SET 2
        0xD0: () => {this._state.b = this.cb_set(2, this._state.b);},
        0xD1: () => {this._state.c = this.cb_set(2, this._state.c);},
        0xD2: () => {this._state.d = this.cb_set(2, this._state.d);},
        0xD3: () => {this._state.e = this.cb_set(2, this._state.e);},
        0xD4: () => {this._state.h = this.cb_set(2, this._state.h);},
        0xD5: () => {this._state.l = this.cb_set(2, this._state.l);},
        0xD6: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_set(2, this._mmu.read_byte(addr)));},
        0xD7: () => {this._state.a = this.cb_set(2, this._state.a);},

        //SET 3
        0xD8: () => {this._state.b = this.cb_set(3, this._state.b);},
        0xD9: () => {this._state.c = this.cb_set(3, this._state.c);},
        0xDA: () => {this._state.d = this.cb_set(3, this._state.d);},
        0xDB: () => {this._state.e = this.cb_set(3, this._state.e);},
        0xDC: () => {this._state.h = this.cb_set(3, this._state.h);},
        0xDD: () => {this._state.l = this.cb_set(3, this._state.l);},
        0xDE: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_set(3, this._mmu.read_byte(addr)));},
        0xDF: () => {this._state.a = this.cb_set(3, this._state.a);},

        //SET 4
        0xE0: () => {this._state.b = this.cb_set(4, this._state.b);},
        0xE1: () => {this._state.c = this.cb_set(4, this._state.c);},
        0xE2: () => {this._state.d = this.cb_set(4, this._state.d);},
        0xE3: () => {this._state.e = this.cb_set(4, this._state.e);},
        0xE4: () => {this._state.h = this.cb_set(4, this._state.h);},
        0xE5: () => {this._state.l = this.cb_set(4, this._state.l);},
        0xE6: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_set(4, this._mmu.read_byte(addr)));},
        0xE7: () => {this._state.a = this.cb_set(4, this._state.a);},

        //SET 5
        0xE8: () => {this._state.b = this.cb_set(5, this._state.b);},
        0xE9: () => {this._state.c = this.cb_set(5, this._state.c);},
        0xEA: () => {this._state.d = this.cb_set(5, this._state.d);},
        0xEB: () => {this._state.e = this.cb_set(5, this._state.e);},
        0xEC: () => {this._state.h = this.cb_set(5, this._state.h);},
        0xED: () => {this._state.l = this.cb_set(5, this._state.l);},
        0xEE: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_set(5, this._mmu.read_byte(addr)));},
        0xEF: () => {this._state.a = this.cb_set(5, this._state.a);},

        //SET 6
        0xF0: () => {this._state.b = this.cb_set(6, this._state.b);},
        0xF1: () => {this._state.c = this.cb_set(6, this._state.c);},
        0xF2: () => {this._state.d = this.cb_set(6, this._state.d);},
        0xF3: () => {this._state.e = this.cb_set(6, this._state.e);},
        0xF4: () => {this._state.h = this.cb_set(6, this._state.h);},
        0xF5: () => {this._state.l = this.cb_set(6, this._state.l);},
        0xF6: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_set(6, this._mmu.read_byte(addr)));},
        0xF7: () => {this._state.a = this.cb_set(6, this._state.a);},

        //SET 7
        0xF8: () => {this._state.b = this.cb_set(7, this._state.b);},
        0xF9: () => {this._state.c = this.cb_set(7, this._state.c);},
        0xFA: () => {this._state.d = this.cb_set(7, this._state.d);},
        0xFB: () => {this._state.e = this.cb_set(7, this._state.e);},
        0xFC: () => {this._state.h = this.cb_set(7, this._state.h);},
        0xFD: () => {this._state.l = this.cb_set(7, this._state.l);},
        0xFE: () => {const addr = get_hl(this._state); this._mmu.write_byte(addr, this.cb_set(7, this._mmu.read_byte(addr)));},
        0xFF: () => {this._state.a = this.cb_set(7, this._state.a);},
    };
    ...
    private ADD_A_MHL() {
        const addr = get_hl(this._state);
        const res = add8Bit(this._state.a, this._mmu.read_byte(addr));
        this._state.a = res.res;
        this.set_flags(res.zero, 0, res.halfCarry, res.carry);
        return 4;
    }
    ...
    //0x87 : ADD_A_A
    private ADD_A_A() {
        const res = add8Bit(this._state.a, this._state.a);
        this._state.a = res.res;
        this.set_flags(res.zero, 0, res.halfCarry, res.carry);
        return 4;
    }
    ...
    private PUSH_BC() {
        this._sp--;
        this._mmu.write_byte(this._sp--, this._state.b);
        this._mmu.write_byte(this._sp, this._state.c);
        return 16;
    }
    ...
    //0xCA : JP_Z_A16
    private JP_Z_A16(args: Uint8Array) {
        if(this.get_zero()) {
    ...
    private CB(args: Uint8Array) {
        this.cb[args[0]]();
        console.error("TODO: Implement mcycles");
    }
    ...
    private PUSH_DE(): number {
        this._sp--;
        this._mmu.write_byte(this._sp--, this._state.d);
        this._mmu.write_byte(this._sp, this._state.e);
        return 16;
    }
    ...
    private PUSH_HL(): number {
        this._sp--;
        this._mmu.write_byte(this._sp--, this._state.h);
        this._mmu.write_byte(this._sp, this._state.l);
        return 16;
    }
    ...
    private JP_MHL(): number {
        this._pc = this._mmu.read_byte(get_hl(this._state));
        return 4;
    }
    ...
    private PUSH_AF(): number {
        this._sp--;
        this._mmu.write_byte(this._sp--, this._state.a);
        this._mmu.write_byte(this._sp, this._state.f);
        return 16;
    }
